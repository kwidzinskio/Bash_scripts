...
# scp fail2ban_install_1.2.0.sh root@server_ip:~/
# Grant permissions to the script:
# sudo chmod +x fail2ban_install_1.2.0.sh
# Execute the file:
# sudo ./fail2ban_install_1.2.0.sh
...
# add automatic overwriting of maxretry and bantime according to script values 

#-----------------------------------------------------------------------------------------------------------
#                                       Script parameters and variables
#-----------------------------------------------------------------------------------------------------------

SCRIPT_NAME="fail2ban_install_1.2.0.sh"
