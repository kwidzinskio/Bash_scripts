...
# scp bash_aliases_0.2.0.sh root@server_ip:~/
# Grant permissions to the script:
# sudo chmod +x bash_aliases_0.2.0.sh
# Execute the file:
# source ./bash_aliases_0.2.0.sh
...
# added creating file to store aliases repo
# added aloading bash aliases repo for etc/.shared_aliases and root/.bash_aliases if not up to date with script
# added multiple aliases adding in own aliases
# added listing all aliases of user
...
SCRIPT_NAME="bash_aliases_0.2.0.sh"
