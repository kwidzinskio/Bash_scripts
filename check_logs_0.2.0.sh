...
# scp check_logs_0.2.0.sh root@server_ip:~/
# Grant permissions to the script:
# sudo chmod +x check_logs_0.2.0.sh
# Execute the file:
# sudo ./check_logs_0.2.0.sh
...
# added options of logs:
# [4] - at specified date
# [5] - specified date and specified phrase
...
SCRIPT_NAME="check_logs_0.2.0.sh"
