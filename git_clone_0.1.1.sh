...
# scp git_clone_0.1.1.sh root@server_ip:~/
# Grant permissions to the script:
# sudo chmod +x git_clone_0.1.1.sh
# Execute the file:
# sudo ./git_clone_0.1.1.sh
...
# version 0.1.1 [2022-05-23]
# added path declaration as an option to clone repo
...
SCRIPT_NAME="git_clone_0.1.1.sh"
